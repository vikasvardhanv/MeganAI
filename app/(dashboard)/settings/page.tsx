...
import { User, Key, Palette, Save, Eye, EyeOff, Check, AlertCircle, Terminal, Copy } from "lucide-react"
                                        ...
                                        <div key={provider.id} className="space-y-2 p-4 border rounded-lg">
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <Button
                                                    ...
                                                    disabled={!apiKeys[provider.id] || isLoading}
                                                >
                                                    Save
                                                </Button>
                                            </div>
                        ...
                        <div className="space-y-6">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Generate code from your terminal using the MeganAi CLI.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <div className="space-y-2">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex gap-2">
                                            <Input
                                                type="password"
                                                value="megan_live_xxxxxxxxxxxxxxxxxxxx"
                                                readOnly
                                                className="font-mono"
                                            />
                                            <Button variant="outline" size="icon">
                            ...
                            <Card>
                                <CardHeader>
                                    <CardTitle>CLI Usage Examples</CardTitle>
                                    <CardDescription>Common commands and workflows.</CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <div className="space-y-4 font-mono text-sm">
                                        <div className="bg-slate-900 text-slate-100 p-4 rounded-lg space-y-2">
                                            <p className="text-slate-400"># Create a new Python FastAPI project</p>
                                            <p>meganai generate &quot;Python FastAPI with PostgreSQL and Stripe&quot;</p>
                                            <p className="text-slate-400 mt-4"># Create in specific directory</p>
                                            <p>meganai generate &quot;React dashboard&quot; --output ./my-app</p>
                                            <p className="text-slate-400 mt-4"># Use specific language</p>
                                            <p>meganai generate &quot;REST API&quot; --lang python</p>
                                            <p className="text-slate-400 mt-4"># List your projects</p>
                                            <p>meganai projects list</p>
                                        </div>
                                    </div>
                                </CardContent>
                            </Card>
